...
class SomExpansion(dbAgent:SomDbAgent)
{
  ...
  def checkExpansion:Unit = {
    ...
    val allLevels:Option[List[_]] = dbAgent.getPositionMapTree
    allLevels match {
      ...
      case Some(levelData) => {
        ...
        //Go through all parent nodes for the maps. 
